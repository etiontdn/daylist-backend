...
export class Perfil {
    ...
    constructor(dados?: Partial<Perfil>) {
        if (dados) {
            ...
            this._ultimaOfensiva = dados.ultimaOfensiva
                ? new Date(dados.ultimaOfensiva)
                : new Date(0);
        }
    }
    ...
    set sexo(value: SexoEnum) {
        this._sexo = value;
    }
    get alturaCm(): number {
        return this._alturaCm;
    }
    set alturaCm(value: number) {
        this._alturaCm = value;
    }
    get pesoKg(): number {
        return this._pesoKg;
    }
    set pesoKg(value: number) {
        this._pesoKg = value;
    }
    get ofensivaAtual(): number {
        return this._ofensivaAtual;
    }
    set ofensivaAtual(value: number) {
        this._ofensivaAtual = value;
    }
    get maiorOfensiva(): number {
        return this._maiorOfensiva;
    }
    set maiorOfensiva(value: number) {
        this._maiorOfensiva = value;
    }
    get ultimaOfensiva(): Date {
        return this._ultimaOfensiva;
    }
    set ultimaOfensiva(value: Date) {
        this._ultimaOfensiva = value;
    }
    ...
    public verificarOfensiva(registrosOntem: RegistroHabito[]): boolean {
        ...
        const todosConcluidos = registrosOntem.every(
            (registro) => registro.status === StatusHabitoEnum.CONCLUIDO
        );
    ...
    toJSON(): any {
        return {
            ...
            sexo: this._sexo,
            alturaCm: this._alturaCm,
            pesoKg: this._pesoKg,
            ofensivaAtual: this._ofensivaAtual,
            maiorOfensiva: this._maiorOfensiva,
            ultimaOfensiva: this._ultimaOfensiva,
        };
    }
}
